...
Revision ID: 1f4b9c7e932a
Revises: e5a90ee5e1ba
Create Date: 2025-03-26 19:20:50.744302
...
revision: str = '1f4b9c7e932a'
down_revision: Union[str, None] = 'e5a90ee5e1ba'
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            'telegram_id', sa.VARCHAR(), autoincrement=False, nullable=True
        ),
        sa.Column(
